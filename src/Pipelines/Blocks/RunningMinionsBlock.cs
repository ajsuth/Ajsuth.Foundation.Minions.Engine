// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RunningMinionsBlock.cs" company="Sitecore Corporation">
...
namespace Ajsuth.Foundation.Minions.Engine.Pipelines.Blocks
{
	...
	///     </cref>
	/// </seealso>
	[PipelineDisplayName(MinionsConstants.Pipelines.Blocks.RunningMinions)]
    public class RunningMinionsBlock : PipelineBlock<string, IEnumerable<MinionPolicy>, CommercePipelineExecutionContext>
    {
		/// <summary>
        ...
        public RunningMinionsBlock(CommerceCommander commander)
		    : base(null)
		{
        ...
        {
            return Task.FromResult(context.CommerceContext.Environment.RunningMinions.AsEnumerable());
        }
    }
}